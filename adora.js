...
function setPresenceForAdora() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.user.setActivity("a! help", { type: 'LISTENING' })["catch"](console.error)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function logFloorGangText(appendtxt) {
    ...
    fs_1.appendFile("logs/" + fsnewdate + '.log.txt', finalfswrite, function (err) {
        if (err)
...
client.on('message', function (message) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        commandhandler_1.commandHandler(message, client, config, dogstatsd);
        setPresenceForAdora();
        return [2 /*return*/];
    });
}); });
