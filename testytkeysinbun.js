...
function testfunction(category, list) {
    var _this = this;
    var statuses = {};
    list.forEach(function (key, keyIndex) {
        statuses["daemon" + keyIndex] = "Loading...";
    });
    list.forEach(function (key, keyIndex) { return __awaiter(_this, void 0, void 0, function () {
        var pathForYtRequest;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    pathForYtRequest = "https://youtube.googleapis.com/youtube/v3/videos?part=statistics&id=hr-325mclek&key=" + key;
